#############################################################################
# Makefile for building: obj/project
...
INCPATH       = -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtQuick -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtQml -isystem /usr/include/qt5/QtNetwork -isystem /usr/include/qt5/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib64/qt5/mkspecs/linux-g++
...
DISTDIR = /home/ry/code/opus47/farm/.tmp/project1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = main.cpp qrc_qmake_qmake_immediate.cpp
OBJECTS       = main.o \
...
Makefile: project.pro .qmake.conf /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
